...
def main():
    ...
    # Generate the output filename based on city_name and years
    if start_year == end_year:
        output_filename = f"{city_name} {start_year}.xlsx"
    else:
        output_filename = f"{city_name} {start_year} - {end_year}.xlsx"
