...
def save_batch_images(prayer_times_list, output_directory):
    ...
    for (year, month), group in grouped:
        ...
        fig_width = len(table_data.columns) * .8
        fig_height = len(table_data) * 0.2
        ...
        # Set title and save the image
        plt.suptitle(f'{month} {year}', fontsize=16, ha='center', va='center', y=1.05)
...
def main():
    ...
    # Save prayer times to Excel and generate batch images
    save_prayer_times_to_xlsx(all_prayer_times, output_xlsx_path)
    save_batch_images(all_prayer_times, output_image_directory)
