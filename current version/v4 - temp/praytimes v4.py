...
Date: 30-09-2024
----------------------------------------------------------
This program takes a start year, end year, and latitude/longitude coordinates to generate an .xlsx file of prayer times from 01-Jan-StartYear to 31-Dec-EndYear.
