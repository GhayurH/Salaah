...
def save_prayer_times_to_csv(prayer_times_list, output_file):
...
# Save the prayer times to an csv file
output_file = 'prayer_times_2024.csv'
save_prayer_times_to_csv(all_prayer_times, output_file)
